...
import com.acatapps.videomaker.databinding.FragmentMediaListBinding
...
class MediaListFragment : Fragment(), KodeinAware {
    ...
    private lateinit var fragmentBinding: FragmentMediaListBinding
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        fragmentBinding = FragmentMediaListBinding.bind(requireView())
    ...
    private fun initView() {
        ...
        fragmentBinding.allMediaListView.apply {
