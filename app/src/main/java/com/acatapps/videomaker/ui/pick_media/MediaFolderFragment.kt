...
import com.acatapps.videomaker.databinding.FragmentMediaFolderBinding
...
class MediaFolderFragment : Fragment(), KodeinAware {
    ...
    private lateinit var fragmentBinding: FragmentMediaFolderBinding
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        fragmentBinding = FragmentMediaFolderBinding.bind(requireView())
    ...
    private fun initView() {
        ...
        mMediaFolderAdapter.onClickItem = {
            ...
            fragmentBinding.mediaFolderListView.apply {
    ...
    private fun setFolderListView() {
        ...
        fragmentBinding.mediaFolderListView.adapter = mMediaFolderAdapter
        fragmentBinding.mediaFolderListView.layoutManager = GridLayoutManager(context, numberCols.toInt(), LinearLayoutManager.VERTICAL, false)
    }
    ...
    private fun listen() {
        ...
        mPickMediaViewModel.folderIsShowingLiveData.observe(viewLifecycleOwner, Observer {
            if(fragmentBinding.mediaFolderListView.adapter is MediaListAdapter) setFolderListView()
        })
