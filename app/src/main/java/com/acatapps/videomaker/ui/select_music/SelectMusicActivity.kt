...
import com.acatapps.videomaker.databinding.ActivitySelectMusicBinding
...
class SelectMusicActivity : BaseActivity(), KodeinAware {
    ...
    private lateinit var mSelectMusicContentBinding: ActivitySelectMusicBinding
    ...
    override fun initViews() {
        mSelectMusicContentBinding = ActivitySelectMusicBinding.bind(binding.mainContentLayout.getChildAt(0))
        ...
        mSelectMusicContentBinding.musicListView.adapter = mMusicListAdapter
        mSelectMusicContentBinding.musicListView.layoutManager = LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false)
    ...
    private fun listen() {
        mSelectMusicViewModel.localStorageData.audioDataResponse.observe(this, Observer {
            ...
            mCurrentMusic?.let {musicReturnData ->
                ...
                if(index >= 0) {
                    mSelectMusicContentBinding.musicListView.scrollToPosition(index)
