...
import com.acatapps.videomaker.databinding.LayoutChangeEffectToolsBinding
...
class VideoSlideActivity2 : BaseSlideShow() {
    ...
    override fun doInitViews() {
        ...
        toolsBinding.changeThemeTools.visibility = View.GONE
        toolsBinding.changeTransitionTools.visibility = View.GONE
        toolsBinding.changeDurationTools.visibility = View.GONE
        toolsBinding.changeFilterTools.visibility = View.GONE
        ...
        toolsBinding.videoControllerView.setMaxDuration(totalDuration)
    ...
    private fun listenTime() {
        mTimeListener = object : CountDownTimer(60 * 60 * 1000, 40) {
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                runOnUiThread {
                    toolsBinding.videoControllerView.setCurrentDuration(mTimelineOffset + position)
    ...
    override fun doInitActions() {
        ...
        toolsBinding.slideBgPreview.setOnClickListener {
        ...
        toolsBinding.changeEffectTools.setOnClickListener {
    ...
    private fun changeVideo(
        ...
        if (mPlayer == null) {
            ...
            mGPUPlayerView.setSimpleExoPlayer(mPlayer as SimpleExoPlayer)
        ...
        mPlayer?.prepare()
        Logger.e("size = ${toolsBinding.slideGlViewContainer.layoutParams.width} ${toolsBinding.slideGlViewContainer.layoutParams.height}")
    }
    ...
    private fun showLayoutChangeEffect() {
        val changeEffectBinding = LayoutChangeEffectToolsBinding.inflate(layoutInflater, toolsBinding.toolsAction, false)
        showToolsActionLayout(changeEffectBinding.root)

        changeEffectBinding.videoInChangeEffect.adapter = mSlideSourceAdapter
        mSlideSourceAdapter.addImagePathList(mVideoPathList)
        changeEffectBinding.videoInChangeEffect.layoutManager =
            LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false)

        changeEffectBinding.effectListView.adapter = mGSEffectListAdapter
        changeEffectBinding.effectListView.layoutManager =
            LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false)
        changeEffectBinding.icAddPhotoInChangeEffect.setOnClickListener {
            doAddMoreVideo()
        }
    ...
    private fun prepareForExport(quality: Int, ratio: Int) {
        ...
        Thread {
            ...
            val stickerContainerWidth = toolsBinding.stickerContainer.width
            val stickerContainerHeight = toolsBinding.stickerContainer.height
