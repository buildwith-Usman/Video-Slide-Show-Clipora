...
class VideoSlideActivity : BaseSlideShow() , MediaPlayer.OnCompletionListener {
    ...
    override fun doInitViews() {
        ...
        mVideoSlideRenderer = VideoPlayerSlideRenderer(mVideoPathList[mCurrentVideoIndex], this, mVideoPlayerSlideGLView) {
            ...
            runOnUiThread {
                toolsBinding.videoControllerView.setCurrentDuration(mTimelineOffset+it)
    ...
    private fun showLayoutChangeEffect() {
        ...
        changeEffectBinding.videoInChangeEffect.layoutManager = LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false)

        changeEffectBinding.effectListView.adapter = mGSEffectListAdapter
        changeEffectBinding.effectListView.layoutManager = LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false)
