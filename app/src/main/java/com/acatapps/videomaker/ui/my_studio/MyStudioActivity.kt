...
import com.acatapps.videomaker.databinding.ActivityMyStudioBinding
...
class MyStudioActivity : BaseActivity() {
    ...
    private lateinit var mMyStudioBinding: ActivityMyStudioBinding

    override fun initViews() {
        mMyStudioBinding = ActivityMyStudioBinding.bind(binding.mainContentLayout.getChildAt(0))
        ...
        setSubRightButton(R.drawable.ic_check_all_none) {
            ...
            if(allItemChecked) {
                ...
                binding.headerView.subRightButton.setImageResource(R.drawable.ic_check_all_none)
            } else {
                selectAll()
                binding.headerView.subRightButton.setImageResource(R.drawable.ic_check_all)
            }
        ...
        mMyStudioBinding.allMyStudioListView.apply {
               ...
               runOnUiThread {
                ...
                runOnUiThread {
                    ...
                    if(myStudioDataList.size > 0) {
                        mAllMyStudioAdapter.notifyDataSetChanged()
                        mMyStudioBinding.iconNoItem.visibility = View.GONE
                    } else {
                        mMyStudioBinding.iconNoItem.visibility = View.VISIBLE
                    }
                    dismissProgressDialog()
                }
            }
    ...
    private fun updateEmptyIcon() {
        Thread{
            ...
            if(total <= 0) {
                runOnUiThread {
                    mMyStudioBinding.iconNoItem.visibility = View.VISIBLE
                    mMyStudioBinding.allMyStudioListView.visibility = View.GONE
                }

            } else {
                runOnUiThread {
                    mMyStudioBinding.iconNoItem.visibility = View.GONE
                    mMyStudioBinding.allMyStudioListView.visibility = View.VISIBLE
                }
