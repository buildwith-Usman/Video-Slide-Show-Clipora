...
import com.acatapps.videomaker.databinding.ItemTextStickerAddedBinding
...
class TextStickerAddedAdapter(private val onChange: OnChange) : BaseAdapter<TextStickerAddedDataModel>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
        val binding = ItemTextStickerAddedBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return BaseViewHolder(binding)
    }

    override fun onBindViewHolder(holder: BaseViewHolder, position: Int) {
        val binding = holder.binding as ItemTextStickerAddedBinding
        ...
        binding.textContent.text = item.text
    }
