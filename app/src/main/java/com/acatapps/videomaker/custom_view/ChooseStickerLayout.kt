...
import com.acatapps.videomaker.databinding.LayoutChooseStickerBinding
...
class ChooseStickerLayout:LinearLayout {
    ...
    private lateinit var binding: LayoutChooseStickerBinding
    ...
    private fun initAttrs(attrs: AttributeSet?) {
        ...
        binding = LayoutChooseStickerBinding.inflate(LayoutInflater.from(context), this, true)

        val col = DimenUtils.screenWidth(context)/(DimenUtils.density(context)*56)
        binding.stickerListView.adapter = mStickerListAdapter
        binding.stickerListView.layoutManager = GridLayoutManager(context, 5)
    ...
    private fun initActions() {
        binding.collectionView1.setOnClickListener {
            mStickerListAdapter.setItemList(getStickerCollection1())
        }

        binding.collectionView2.setOnClickListener {
            mStickerListAdapter.setItemList(getStickerCollection2())
        }

        binding.collectionView3.setOnClickListener {
            mStickerListAdapter.setItemList(getStickerCollection3())
        }

        binding.collectionView4.setOnClickListener {
            mStickerListAdapter.setItemList(getStickerCollection4())
        }

        binding.collectionView5.setOnClickListener {
            mStickerListAdapter.setItemList(getStickerCollection5())
        }

        binding.collectionView6.setOnClickListener {
            mStickerListAdapter.setItemList(getStickerCollection6())
        }

        binding.collectionView7.setOnClickListener {
            mStickerListAdapter.setItemList(getStickerCollection7())
        }


        binding.collectionView8.setOnClickListener {
            mStickerListAdapter.setItemList(getStickerCollection8())
        }

        binding.collectionView9.setOnClickListener {
